  ...
  return (
    <html lang="en">
      ...
      />
        ...
        {/* Background image + soft overlay (behind everything) */}
        <div
          aria-hidden
          className="fixed inset-0 -z-10 pointer-events-none bg-[url('/images/bg-grid.png')] bg-cover bg-center bg-no-repeat"
        />
